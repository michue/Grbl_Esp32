...
// #define USE_VERSION_003

#define MACHINE_NAME                    "XY DLC32"

#ifdef USE_VERSION_003
#define BOARD_NAME                      "Board:XY DLC32 V003"
#else 
    #ifdef USE_BOARD_V2_0
        #define BOARD_NAME              "Board:XY DLC32 V2.0"
        #define BOARD_VERSION           "MKS DLC32 V2.0"
    #else 
        #define BOARD_NAME              "Board:MKS DLC32 V1.0"
        #define BOARD_VERSION           "MKS DLC32 V1.0"
    #endif
#endif

#ifdef USE_VERSION_003
#define FW_NAME                         "Firmware:V1.2.003_T"
#else
/*Base on 2022072601*/
#define FW_NAME                         "Firmware:V2.08(8M.H35.20230417)"
#define FW_VERSION                      "V2.08(8M.H35.20230417)"
#endif
...
#define HTTP_UPLOAD_BUFLEN  1024*10 // 1436
...
#define LCD_SCK				        -1// GPIO_NUM_18
#define LCD_MISO				    -1// GPIO_NUM_19
#define LCD_MOSI				    -1// GPIO_NUM_23
#define LCD_RS					    -1// GPIO_NUM_33
#define LCD_EN					    -1// GPIO_NUM_5     
#define LCD_RST					    -1// GPIO_NUM_27     
#define LCD_CS					    -1// GPIO_NUM_25
#define TOUCH_CS				    -1// GPIO_NUM_26
#define BEEPER					    I2SO(7)

#define DLC32_TEST                  GPIO_NUM_19
#define DLC32_TEST_1                GPIO_NUM_18

#define IIC_SCL                     GPIO_NUM_4
#define IIC_SDA                     GPIO_NUM_0

#define COOLANT_MIST_PIN            IIC_SCL
...
#define DEFAULT_Z_MAX_RATE                  1000.0 // mm/s
...
#define DEFAULT_SPINDLE_FREQ                1500.0   // 1KHz
