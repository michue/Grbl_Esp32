...
static uint8_t get_event(lv_obj_t* obj) {
    ...
    if      (obj == wifi_src.wifi_btn_line1)            return ID_WIFI_BIT_1;
    else if (obj == wifi_src.wifi_btn_line2)            return ID_WIFI_BIT_2;
    else if (obj == wifi_src.wifi_btn_line3)            return ID_WIFI_BIT_3;
    else if (obj == wifi_src.wifi_btn_line4)            return ID_WIFI_BIT_4;
    else if (obj == wifi_src.wifi_btn_line5)            return ID_WIFI_BIT_5;
    else if (obj == wifi_src.wifi_btn_line6)            return ID_WIFI_BIT_6;
    else if (obj == wifi_src.wifi_btn_line7)            return ID_WIFI_BIT_7;
    else if (obj == wifi_src.wifi_btn_line8)            return ID_WIFI_BIT_8;
    else if (obj == wifi_src.wifi_imgbtn_back)          return ID_WIFI_BACK;

    else if (obj == wifi_src.wifi_label_scanf)          return ID_WIFI_SCANF;
    else if (obj == wifi_src.wifi_label_up)             return ID_WIFI_UP;
    else if (obj == wifi_src.wifi_label_next)           return ID_WIFI_NEXT;
    else if (obj == wifi_src.wifi_label_disconnect)     return ID_WIFI_DISCONNNECD;
}
...
static void event_handler_wifi_bit(uint8_t num) {

    wifi_src.wifi_send_num = num + mks_wifi.wifi_show_page * 8;
    mks_wifi.wifi_choose = wifi_src.wifi_send_num-1;
    draw_pos_wifi_popup("Please enter password to connect",mks_wifi.wifi_name_str[wifi_src.wifi_send_num - 1]);
}
...
static void event_handler(lv_obj_t* obj, lv_event_t event) { 
    ...
    switch(id) {
        ...
        case ID_WIFI_BIT_1: break;
        case ID_WIFI_BIT_2: break;
        case ID_WIFI_BIT_3: break;
        case ID_WIFI_BIT_4: break;
        case ID_WIFI_BIT_5: break;
        case ID_WIFI_BIT_6: break;
        case ID_WIFI_BIT_7: break;
        case ID_WIFI_BIT_8: break;
        case ID_WIFI_BACK: break;
        case ID_WIFI_SCANF: break;
        case ID_WIFI_UP: break;
        case ID_WIFI_NEXT: break;
        case ID_WIFI_DISCONNNECD: break;
    }
}
...
void mks_draw_wifi_scanf(void) { 
    wifi_src.wifi_label_info = mks_lvgl_long_sroll_label_with_wight_set_center(mks_global.mks_src, wifi_src.wifi_label_scanf, 200, 150, mc_language.scanf_ing, 0);
    mks_wifi.wifi_scanf_status = wifi_scanf_begin;
}

void mks_draw_wifi_connecting(void) {   // 

    wifi_src.wifi_label_info = mks_lvgl_long_sroll_label_with_wight_set_center(mks_global.mks_src, wifi_src.wifi_label_scanf, 200, 150, mc_language.tis_wifi_connecting, 0);
...
void mks_draw_wifi_disconnrcting(void) {
    ...
    wifi_src.wifi_label_info = mks_lvgl_long_sroll_label_with_wight_set_center(mks_global.mks_src, wifi_src.wifi_label_scanf, 200, 150, mc_language.disconnecting, 0);
...
void mks_draw_wifi_show(void) {
    ...
    wifi_src.wifi_scr1_style.text.font = &dlc32Font;
    ...
    label_for_imgbtn_name(wifi_src.wifi_src_1, wifi_src.wifi_label_up, wifi_src.wifi_btn_up, 0, 0, mc_language.page_up);
    label_for_imgbtn_name(wifi_src.wifi_src_1, wifi_src.wifi_label_next, wifi_src.wifi_btn_next, 0, 0, mc_language.page_dowm);
...
void mks_draw_wifi_had_connect(void) {
    ...
    label_for_imgbtn_name(wifi_src.wifi_src_1, wifi_src.wifi_label_disconnect, wifi_src.wifi_imgbtn_disconnect, 0, 0, mc_language.re_scanf);
    ...
    if(get_rssi >= 85) sprintf(rssi_str, mc_language.wifi_single_good);
    else if( (get_rssi >=75) && (get_rssi < 85) ) sprintf(rssi_str, mc_language.wifi_signle_min);
    else if( (get_rssi < 75)) sprintf(rssi_str, mc_language.wifi_single_bad);
...
static void event_handler_wifi_connnect(lv_obj_t* obj, lv_event_t event) {
    ...
    if((event == LV_EVENT_RELEASED) || (event == LV_EVENT_PRESS_LOST))  {
        ...
        memcpy(mks_wifi.wifi_name_connect, mks_wifi.wifi_name_str[wifi_src.wifi_send_num-1], sizeof(mks_wifi.wifi_name_str[wifi_src.wifi_send_num-1]));
...
void mks_draw_wifi_kb(char *username) {
    ...
    if(mks_grbl.language == SimpleChinese) {
        sprintf(un_str, WIFI_USERNAME_CH);
    }else if(mks_grbl.language == English) {
        sprintf(un_str, WIFI_USERNAME_EN);
    }else {
        sprintf(un_str, WIFI_USERNAME_EN);
    }
    char rssi_str[138];
    ...
    wifi_src.wifi_src_style.text.font = &dlc32Font;
    ...
    wifi_src.wifi_tb = mks_lv_set_ta(wifi_src.wifi_kb_src_1 ,wifi_src.wifi_tb, wifi_src.wifi_kb, 200, 30, 100, 30);
    ...
    wifi_src.wifi_label_password = mks_lvgl_long_sroll_label_with_wight_set_center(wifi_src.wifi_kb_src_1, wifi_src.wifi_label_password, 10, 30,mc_language.wifi_password, 0);
    ...
    wifi_src.wifi_label_connect = label_for_imgbtn_name_mid(wifi_src.wifi_kb_src_1, wifi_src.wifi_label_connect, wifi_src.wifi_btn_connect, -25, 0, mc_language.connect_btn);
}
